...
// Paths cannot contain . or .. elements, nor may they begin or end with a /.
// This essentially restricts you to only embedding files that are contained in the
// same directory (or a subdirectory) as the source code which has the //go:embed directive
// ↓↓↓↓↓↓
