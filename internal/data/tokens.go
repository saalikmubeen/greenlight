...
func generateToken(userID int64, ttl time.Duration, scope string) (*Token, error) {
	...
	// This wont' be stored in the database. This will be the token string that we send to
	// the user in their welcome email They will look similar to this:
	//
	// Y3QMGX3PJ3WLRL2YRTQGQ6KRHU // 26 bytes long
	//
